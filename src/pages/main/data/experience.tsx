...
export const experience = [
	{
		...
		description: (
			<>
				<p>
					The Feathers was a creative collective primarily consisting of
					students and amateur artists and entertainers who were exploring a
				...
				<p>
					This collective represented an early and earnest attempt at creating
					something driven purely by passion. It led to the development of
					various projects, including StudioFlicks and OutFocus, among others.
				</p>
				<p>
					The collaborative spirit and shared dedication among members fostered
					a nurturing environment for growth and innovation. I feel immense
